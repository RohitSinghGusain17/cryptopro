...
<html lang="en">
    <head>
        ...
        @stack('style-alt')
        <title>Yatra : Travel Website</title>
    </head>
    <body>
        <!--==================== HEADER ====================-->
        <header class="header" id="header">
            <nav class="nav container">
                ...
                <a target="_blank" href="https://api.whatsapp.com/send?phone=86XXXXXXX97&text=I want to booking" class="button nav__button">Booking Now</a>
            </nav>
        </header>
        ...
        <footer class="footer section">
            ...
            <div class="footer__info container">
                <span class="footer__copy">
                    &#169; Rohit and Anubhav : All rigths reserved
                </span>
